define(function (require) {
  return function AggOptionsFactory(Private) {
    ...
    var optionTypeMap = {
      string: Private(require('ui/agg_types/option_types/string')),
      _default: Private(require('ui/agg_types/option_types/base'))
    };
     ...
     */
    _.class(AggOptions).inherits(IndexedArray);
